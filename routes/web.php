...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('presupuesto/{id}/facturar', [PresupuestoController::class, 'facturar'])->name('presupuesto.facturar');
    Route::post('presupuesto/{id}/facturar', [PresupuestoController::class, 'facturarPost'])->name('presupuesto.facturar.post');
    ...
    Route::post('reporteVentaVendedorSucursalPDF', [InformeController::class, 'reporteVentaVendedorSucursalPDF'])->name('reporteVentaVendedorSucursalPDF');
    ...
    Route::get('/facturas/validar-numero', [FacturaController::class, 'validarNumero'])
    ->name('facturas.validar');
